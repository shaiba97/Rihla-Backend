...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get ticketPDF() {
    return this.prisma.ticketPDF;
  }
  get platformFee() {
    return this.prisma.platformFee;
  }
  get paymentAccount() {
    return this.prisma.paymentAccount;
  }
  get expense() {
  ...
  get awardPack() {
    return this.prisma.awardPack;
  }
  get userAward() {
    return this.prisma.userAward;
  }
  get deviceToken() {
  ...
  get payoutRecord() {
    return this.prisma.payoutRecord;
  }
  get payoutRecordItem() {
    return this.prisma.payoutRecordItem;
  }
  get companyBankAccount() {
    return this.prisma.companyBankAccount;
  }
  get withdrawRequest() {
